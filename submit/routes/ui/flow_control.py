"""Handles which UI route to proceeded in ui-app workflows."""
...
def get_workflow(submission: Optional[Submission]) -> WorkflowProcessor:
    """Guesses the workflow based on the ui-app and its version."""
...
def flow_control(blueprint_this_stage: Optional[Stage] = None,
    ...
    the context by checking the ui-app and route. If passed, this
    ...
    def route(controller: Callable) -> Callable:
        ...
        def wrapper(submission_id: str) -> Response:
            ...
            try:
                ...
                #WARNING: controllers do not update the ui-app in this scope
            except BadRequest:
                if action == PREVIOUS:
