"""Provides routes for the ui-app user interface."""
...
def load_submission() -> None:
    """Load the ui-app before the request is processed."""
...
def delete_submission(submission_id: int):
    """Delete, or roll a ui-app back to the last announced state."""
    return handle(cntrls.delete.delete,
                  'submit/confirm_delete_submission.html',
                  'Delete ui-app or replacement', submission_id)
...
def submission_status(submission_id: int) -> Response:
    """Display the current state of the ui-app."""
...
def submission_edit(submission_id: int) -> Response:
    """Redirects to current edit stage of the ui-app."""
...
def testalerts() -> Response:
    ...
    add_immediate_alert(tc, 'WARNING', 'This is a warning to you from the normal ui-app alert system.', "SUBMISSION ALERT TITLE")
