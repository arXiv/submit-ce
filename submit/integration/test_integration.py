"""Tests for the ui-app system integration.

This differs from the test_workflow in that this tests the ui-app
system as an integrated whole from the outside via HTTP requests. This
contacts a ui-app system at a URL via HTTP. test_workflow.py
...
class TestSubmissionIntegration(unittest.TestCase):
    ...
    def test_submission_system_basic(self):
        """Create, upload files, process TeX and submit a ui-app."""
