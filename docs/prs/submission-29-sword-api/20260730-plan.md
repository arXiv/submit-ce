...
- **Same repo, separate process.** The domain/`api`/`implementations` layers are the
  ...
  [`pyproject.toml`](https://github.com/arXiv/submit-ce/tree/develop/pyproject.toml)). But SWORD gets its own entrypoint and Cloud Run service, because
...
- **SWORD is legacy.** A more modern submission API may be added later.
  `submit_ce.api.app:app` and `submit_ce.fastapi.app:app` (referenced by [`main.py`](https://github.com/arXiv/submit-ce/tree/develop/main.py))
  are **reserved for that future API and must be left alone** — SWORD does not reuse
  either name and does not touch [`main.py`](https://github.com/arXiv/submit-ce/tree/develop/main.py).
...
| Fact | Anchor |
|---|---|
| CGI entrypoint; also mounted via Catalyst `WrapCGI` | [`arxiv-httpd/cgi-bin/sword.pl:11-12`](https://github.com/arXiv/arxiv-httpd/tree/develop/cgi-bin/sword.pl#L11-L12), [`arxiv-submit/lib/arXiv/Controller/SwordCGI.pm:9-15`](https://github.com/arXiv/arxiv-submit/tree/develop/lib/arXiv/Controller/SwordCGI.pm#L9-L15) |
| Core server, 1620 lines | [`arxiv-lib/lib/arXiv/AtomPP/AtomPP.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/AtomPP/AtomPP.pm) |
| Basic auth done **outside** the app by Apache `mod_authnz_external` → `cgi-bin/authenticate.pl`, realm `"SWORD at arXiv"`, HTTPS forced | [`arxiv-httpd/conf/sword.conf:10-13,17,27-33`](https://github.com/arXiv/arxiv-httpd/tree/develop/conf/sword.conf#L10-L13) |
| `/sword-license` has **no** `<Location>` auth block → normal cookie auth, not basic | [`arxiv-httpd/conf/sword.conf:20`](https://github.com/arXiv/arxiv-httpd/tree/develop/conf/sword.conf#L20) |
...
| Tracking XML `<deposit>` with `status`/`arxiv_id`/`submission_id`/`error` + **undocumented** base64 `autotex_log_b64` | [`arxiv-submit/lib/arXiv/Controller/Sword.pm:23-103`](https://github.com/arXiv/arxiv-submit/tree/develop/lib/arXiv/Controller/Sword.pm#L23-L103) |
| 39 error codes defined | [`arxiv-lib/lib/arXiv/AtomPP/Config.pm:76-198`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/AtomPP/Config.pm#L76-L198) |
| Error entry shape | [`arxiv-lib/lib/arXiv/AtomPP/Error.pm:44-121`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/AtomPP/Error.pm#L44-L121) |
...
|---|---|---|
| `is_general_category` | [`arxiv-lib/lib/arXiv/Categories.pm:1128-1135`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm#L1128-L1135) | `CATEGORIES[cat].is_general` ([`arxiv-base/arxiv/taxonomy/category.py:113`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/taxonomy/category.py#L113)) |
| `get_archive_from_category` | [`arxiv-lib/lib/arXiv/Categories.pm:938`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm#L938) | `CATEGORIES[cat].in_archive` (`category.py:112`) |
| `canonicalize_category` | [`arxiv-lib/lib/arXiv/Categories.pm:988`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm#L988) | `CATEGORIES[cat].get_canonical()` (`category.py:121-127`) |
| `get_group_from_category` | [`arxiv-lib/lib/arXiv/Categories.pm:1036`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm#L1036) | `CATEGORIES[cat].get_archive().in_group` (`category.py:83,90,116-119`) |
| `is_valid_category_strict` | [`arxiv-lib/lib/arXiv/Categories.pm:1164-1178`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm#L1164-L1178) | `cat in CATEGORIES`, plus the bare-archive rule below |
...
`is_general=True` in [`arxiv-base/arxiv/taxonomy/definitions.py`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/taxonomy/definitions.py) against
...
1. **Namespaces are `http://`, not `https://`.** `Config.pm:50-57` defines
   ...
   as `https://` throughout (e.g. [`arxiv-docs/source/help/submit_sword.md:218-222`](https://github.com/arXiv/arxiv-docs/tree/develop/source/help/submit_sword.md#L218-L222)) —
   a docs-side bulk rewrite artifact. The live regression test confirms `http://`
   ([`arxiv-test-regression/pytest/tests/test_sword.py:67-68`](https://github.com/arXiv/arxiv-test-regression/tree/develop/pytest/tests/test_sword.py#L67-L68)).
...
| [`arxiv-lib/t/lib/Test/Sword.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/t/lib/Test/Sword.pm) | 163 | HTTP client harness (builds the request, parses `edit_media_link`) |
| [`arxiv-lib/t/lib/Test/Sword/Metadata.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/t/lib/Test/Sword/Metadata.pm) | ~120 | Wrapper-XML builder |
| `arxiv-lib/t/arxiv_atompp/data/{sample.pdf,sample.xml}` | — | Fixtures |
| [`arxiv-lib/t/db/sql/arXiv_sword_licenses.sql`](https://github.com/arXiv/arxiv-lib/tree/develop/t/db/sql/arXiv_sword_licenses.sql) | 3 | License rows for users 55596, 91310 |
...
| Fact | Anchor |
|---|---|
| `submit_ce/api/` is the **abstract interface layer**, not an HTTP API | [`submit_ce/api/__init__.py:1-19`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/api/__init__.py#L1-L19) |
| No HTTP API exists yet; [`main.py`](https://github.com/arXiv/submit-ce/tree/develop/main.py) points at `submit_ce.fastapi.app:app`, which does not exist — **reserved for a future modern API, leave alone** | [`main.py:1-3`](https://github.com/arXiv/submit-ce/tree/develop/main.py#L1-L3) |
| Production image runs only the Flask UI | `Dockerfile:88-92` |
| DB-session seam already parameterized: `LegacySubmitImplementation(get_session=...)` | [`submit_ce/implementations/legacy_implementation/flask_impl.py:8-31`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/legacy_implementation/flask_impl.py#L8-L31) |
| Backend wiring lives in `ui/` and imports Flask (`g`, `current_app`, `has_app_context`) | [`submit_ce/ui/backend.py:7`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/backend.py#L7), [`submit_ce/ui/backend.py:98-108`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/backend.py#L98-L108) |
| `compile_api_service.py` reads `current_app.api` in 5 places — the only Flask leak below `ui/` | [`submit_ce/implementations/compile/compile_api_service.py:8,121,188,287,288`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/compile/compile_api_service.py#L8) |
| `SubmitApi.save(*events, submission_id=None)` is the single write path | [`submit_ce/api/submit.py:261-305`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/api/submit.py#L261-L305) |
| Domain events available (incl. `SetProxyInformation`) | [`submit_ce/domain/event/__init__.py:120-1353`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/domain/event/__init__.py#L120-L1353) |
| File events | [`submit_ce/domain/event/file.py:130-242`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/domain/event/file.py#L130-L242) |
| `SubmissionFileStore` is **submission-scoped** throughout | [`submit_ce/api/file_store.py:35-475`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/api/file_store.py#L35-L475) |
| Size limit default is 50 MB — the target for the raised SWORD cap | [`submit_ce/domain/size_limits.py:34`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/domain/size_limits.py#L34), [`submit_ce/domain/size_limits.py:154`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/domain/size_limits.py#L154) |
| No XML library in dependencies (no `lxml`) | [`pyproject.toml`](https://github.com/arXiv/submit-ce/tree/develop/pyproject.toml) |

### Legacy tables — already modelled in `arxiv-base`

| Table | Model | Anchor |
|---|---|---|
| `arXiv_tracking` | `Tracking` (`tracking_id`, unique `sword_id`, `paper_id`, `submission_errors`, `timestamp`) | [`arxiv-base/arxiv/db/models.py:1377-1388`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L1377-L1388) |
| `arXiv_sword_licenses` | `SwordLicense` (`user_id`, `license`, `updated`) | [`arxiv-base/arxiv/db/models.py:2079-2086`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L2079-L2086) |
| `arXiv_submissions.sword_id` FK | `Submission.sword_id` | [`arxiv-base/arxiv/db/models.py:1149`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L1149) |
| `arXiv_demographics` flags | `Demographic.flag_xml`, `flag_proxy`, `flag_suspect`, `veto_status`, `flag_group_*` | [`arxiv-base/arxiv/db/models.py:1998`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L1998), `:2010-2021` |
| `tapir_users.flag_banned` | `TapirUser` | [`arxiv-base/arxiv/db/models.py:1915`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L1915), `:1938` |
| Paper ownership for replacement | `PaperOwner`, `Document`, `TapirNickname` | [`arxiv-base/arxiv/db/models.py:873`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/models.py#L873), `:457`, `:1712` |
...
`arxiv.license.CURRENT_LICENSES` ([`arxiv-base/arxiv/license/__init__.py:124`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/license/__init__.py#L124)).

### Existing regression tests

[`arxiv-test-regression/pytest/tests/test_sword.py`](https://github.com/arXiv/arxiv-test-regression/tree/develop/pytest/tests/test_sword.py) (192 lines) and
...
[`main.py`](https://github.com/arXiv/submit-ce/tree/develop/main.py) is not touched.
...
([`submit_ce/api/file_store.py:35-475`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/api/file_store.py#L35-L475)).
...
| File | What to build |
|---|---|
| [`submit_ce/sword/errors.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/errors.py) | All 39 codes from `Config.pm:76-198`, each mapped to numeric code, message, `href`, and HTTP status. Statuses observed in the Perl: `EAUTH`→401, `ENLIC`→412, `EVMD5`→412, `EMDTP`→415, `EIMPL`→501, `ENAVL`/`EOVLD`→503, everything else→400 (`AtomPP.pm:1530`). |
| [`submit_ce/sword/atom/ns.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/ns.py) | `http://` namespaces and schemes, copied verbatim from `Config.pm:50-57`. Do not use the manual's `https://` forms. |
| [`submit_ce/sword/atom/render.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/render.py) | Service document (`ServiceDoc.pm:96-171`) with per-collection categories (decision 1) and `maxUploadSize` 50000 (decision 5); media/wrapper response entries (`AtomPP.pm:1375-1484`); `sword:error` (`Error.pm:44-121`). Preserve the scheme mix in links (`https://` for edit/edit-media/content/generator, `http://` for `alternate`). |
| [`submit_ce/sword/atom/parse.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/parse.py) | Wrapper parsing + the full validation ladder from `AtomPP.pm:924-1231`. `summary` uses strict `> 20` (`AtomPP.pm:1088`); the `rel="related"` href regex is `^https?://\S+/sword-app/edit/((\d{4})\d{4,})` (`AtomPP.pm:1102`). Category rules via `arxiv.taxonomy` per the mapping table above. |
| [`submit_ce/sword/auth.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/auth.py) | `HTTPBasic` → `arxiv.auth.legacy.authenticate`; then the gate from `AtomPP.pm:183` against `Demographic`/`TapirUser`; then license check against `arxiv.license.CURRENT_LICENSES` (`AtomPP.pm:1553`). Username is the **tapir nickname** and case-sensitive (`submit_sword.md:726-727`). Also the `flag_suspect` check (`AtomPP.pm:1589-1607`). |
| [`submit_ce/sword/collections.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/collections.py) | `<abbrev>-collection` ↔ `grp_<abbrev>`, and allowed groups from `Demographic.flag_group_*` (`AtomPP.pm:555-573`). Note this is group membership, **not** `SubmitApi.categories_for_user`, which is endorsement-based ([`submit_ce/api/submit.py:322-331`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/api/submit.py#L322-L331)). |
| [`submit_ce/sword/deposits.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/deposits.py) | Staging store + `YYMM####` id allocator via GCS `if-generation-match`. 50 MB body cap. |
| [`submit_ce/sword/ingest.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/ingest.py) | Validated wrapper → the event sequence above, through `SubmitApi.save()`. Writes the `arXiv_tracking` row with `paper_id = submit/<submission_id>`. |
| [`submit_ce/sword/tracking.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tracking.py) | `GET /resolve/app/<id>`, reproducing `Controller/Sword.pm:23-103` including `autotex_log_b64` and `submission_errors`. |
| [`submit_ce/sword/app.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/app.py) | App factory; routes; a non-Flask `get_session` provider for `LegacySubmitImplementation`. |

### New — ported tests

| File | Ports from | Notes |
|---|---|---|
| [`submit_ce/sword/tests/client.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/client.py) | [`arxiv-lib/t/lib/Test/Sword.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/t/lib/Test/Sword.pm) | Request builder + response parser as a pytest helper over FastAPI `TestClient`. Credentials from fixtures, never hardcoded. |
| [`submit_ce/sword/tests/wrapper.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/wrapper.py) | [`arxiv-lib/t/lib/Test/Sword/Metadata.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/t/lib/Test/Sword/Metadata.pm) | Wrapper-XML factory. **Fix** the four helper defects listed above so `comment`/`journal_ref`/`doi`/`report_no` are actually emitted correctly and therefore actually tested. |
| [`submit_ce/sword/tests/conftest.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/conftest.py) | [`arxiv-lib/t/lib/Test/DB.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/t/lib/Test/DB.pm), `t/db/sql/arXiv_sword_licenses.sql` | Fixture users mirroring `auth.t`: one fully-privileged depositor with a license, one without flags and without a license, one suspect. |
...
| File | Lines | Change |
|---|---|---|
| [`submit_ce/implementations/compile/compile_api_service.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/compile/compile_api_service.py) | 8, 121, 188, 287, 288 | Remove `from flask import current_app`; take the `SubmissionFileStore` via constructor or method parameter instead of reading `current_app.api`. **Required** — there is no Flask app context in the FastAPI process. Touches the Flask UI too, so the UI test suite must pass unchanged. |
| [`submit_ce/ui/backend.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/backend.py) | 27-49 | Extract `config_backend_api()` (and `email_service_from_settings`) into a framework-neutral module both apps import. Leave the Flask-specific `get_submission`/`backend_startup_health_check` helpers where they are. |
| [`submit_ce/ui/config.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/config.py) | 13-30 | Make `Settings` importable without Flask; add SWORD settings (deposit bucket/prefix, retention days, 50 MB `maxUploadSize`). |
| [`submit_ce/implementations/legacy_implementation/fastapi_impl.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/legacy_implementation/fastapi_impl.py) | 1-2 | Replace the TODO with the real non-Flask implementation supplying a plain SQLAlchemy `get_session`, mirroring `flask_impl.py:8-31`. |
| [`pyproject.toml`](https://github.com/arXiv/submit-ce/tree/develop/pyproject.toml) | dependencies | Add `lxml` — Atom generation with correct namespace prefixes is painful with stdlib `xml.etree`. |
...
- [`main.py`](https://github.com/arXiv/submit-ce/tree/develop/main.py) — reserved for the future modern API.
- `submit_ce/api/app.py` / `submit_ce/fastapi/` — reserved namespaces, not created here.
- [`CLAUDE.md`](https://github.com/arXiv/arxiv-developer/tree/develop/workspace/CLAUDE.md)'s `submit_ce.api.app:app` command line — left as-is per the same reservation.

### Read-only references

`arxiv-lib/lib/arXiv/AtomPP/{AtomPP,Config,Error,ServiceDoc}.pm`,
[`arxiv-lib/lib/arXiv/Categories.pm`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Categories.pm), `arxiv-lib/t/arxiv_atompp/*`,
`arxiv-lib/t/lib/Test/Sword*`, [`arxiv-submit/lib/arXiv/Controller/Sword.pm`](https://github.com/arXiv/arxiv-submit/tree/develop/lib/arXiv/Controller/Sword.pm),
[`arxiv-httpd/conf/sword.conf`](https://github.com/arXiv/arxiv-httpd/tree/develop/conf/sword.conf), [`arxiv-docs/source/help/submit_sword.md`](https://github.com/arXiv/arxiv-docs/tree/develop/source/help/submit_sword.md).
...
10. Namespace assertion: rendered XML contains `http://arxiv.org/terms/arXiv/`, never
    ...
    [`arxiv-test-regression/pytest/tests/test_sword.py:67-68`](https://github.com/arXiv/arxiv-test-regression/tree/develop/pytest/tests/test_sword.py#L67-L68) makes. The malformed-namespace
...
13. Confirm the created submission is indistinguishable from a UI submission: same
    ...
    `arXiv_submissions`.
14. Point [`arxiv-test-regression/pytest/tests/test_sword.py`](https://github.com/arXiv/arxiv-test-regression/tree/develop/pytest/tests/test_sword.py) and `test_sword_gcp.py` at
...
4. **`errors.py` + `atom/ns.py` + `atom/render.py`** — pure functions, no I/O
   (verify: steps 4, 10).
5. **Test scaffolding**: [`conftest.py`](https://github.com/arXiv/submit-ce/tree/develop/conftest.py) fixtures, `client.py`, `wrapper.py` — ported
...
[`submit_ce/implementations/tests/test_compile_api_service.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/tests/test_compile_api_service.py) needed updating: it
...
New [`submit_ce/implementations/wiring.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/wiring.py) holds `config_backend_api` and
...
come out of `ui/`, but [`submit_ce/ui/config.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/config.py) and [`submit_ce/ui/__init__.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/__init__.py) import
...
id otherwise** ([`arxiv-base/arxiv/db/__init__.py:88-94`](https://github.com/arXiv/arxiv-base/tree/develop/arxiv/db/__init__.py#L88-L94)). So the existing session
...
New [`submit_ce/implementations/legacy_implementation/tests/test_fastapi_impl.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/implementations/legacy_implementation/tests/test_fastapi_impl.py) (5
...
[`test.sh`](https://github.com/arXiv/submit-ce/tree/develop/test.sh) passed unchanged and attempted **zero** outbound connections. Email is
...
1. New repo-root [`conftest.py`](https://github.com/arXiv/submit-ce/tree/develop/conftest.py) pins `EMAIL_MODE=TESTING`, `QA_PUBSUB_ENABLED=False`,
...
3. [`submit_ce/tests/test_guards.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/tests/test_guards.py) (5 tests) asserts the guards actually hold, so they
   cannot rot silently. Added `submit_ce/tests` to [`test.sh`](https://github.com/arXiv/submit-ce/tree/develop/test.sh); CI collects it already.
...
Also added ahead of it, at the user's request: [`local_sword.py`](https://github.com/arXiv/submit-ce/tree/develop/local_sword.py) plus a minimal
[`submit_ce/sword/app.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/app.py) (factory, `db.init`, non-Flask `SubmitApi` on
`app.state.api`, one I/O-free `GET /status`). Verified running: `/status` → `ok`
200 on port 8001, alongside [`local_ui.py`](https://github.com/arXiv/submit-ce/tree/develop/local_ui.py) on 8000.

- [`submit_ce/sword/atom/ns.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/ns.py) — namespaces, schemes, versions. All `http://`.
- [`submit_ce/sword/errors.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/errors.py) — all 39 codes with message, href and default HTTP
  status, plus a `SwordFault` exception carrying the `": detail"` summary suffix.
- [`submit_ce/sword/atom/render.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/render.py) — `render_error()` producing the
...
- 80 tests in `submit_ce/sword/tests/`, including an independently transcribed
  ...
  assert on. Added `submit_ce/sword` to [`test.sh`](https://github.com/arXiv/submit-ce/tree/develop/test.sh).
...
not a declared dependency ([`lint.sh`](https://github.com/arXiv/submit-ce/tree/develop/lint.sh) installs it ad hoc). Reinstalling brought
...
- [`submit_ce/sword/tests/wrapper.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/wrapper.py) — wrapper-entry builder replacing
...
- [`submit_ce/sword/tests/client.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/client.py) — depositor client replacing
...
- [`submit_ce/sword/tests/conftest.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/conftest.py) — four depositor fixtures on a
...
- [`submit_ce/sword/auth.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/auth.py) — the three gates in legacy's order: Basic credentials,
...
- [`submit_ce/sword/collections.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/collections.py) — collection↔group mapping, `flag_group_*`
  permissions, and per-collection category terms off `arxiv.taxonomy`.
- [`submit_ce/sword/atom/servicedoc.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/servicedoc.py) — the service document.
...
1. **Every `test` category is flagged inactive** in `arxiv.taxonomy`, so
   ...
   ([`arxiv-test-regression/pytest/tests/test_sword.py:67`](https://github.com/arXiv/arxiv-test-regression/tree/develop/pytest/tests/test_sword.py#L67)). `include_inactive` is
...
Also: [`submit_ce/sword/tests/conftest.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tests/conftest.py) now repoints `settings.CLASSIC_DB_URI`
...
- [`submit_ce/sword/deposits.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/deposits.py) — `DepositStore` (abstract, with the allocation
  retry loop shared by every backend), `InMemoryDepositStore`, the media-type →
  extension mapping, and the `YYMM####` id format.
- [`submit_ce/sword/gs_deposits.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/gs_deposits.py) — `GsDepositStore`, mirroring legacy's
...
- [`submit_ce/sword/request.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/request.py) — SWORD header parsing (`X-On-Behalf-Of`,
...
[`submit_ce/sword/atom/parse.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/atom/parse.py) — `parse_wrapper()` returning a validated
...
- [`submit_ce/sword/ingest.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/ingest.py) — `metadata_events()` / `upload_events()` (pure,
...
`GET /resolve/app/<sword_id>` in [`submit_ce/sword/tracking.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/tracking.py), answering the
...
* **Validity** comes from `%Subj_class_name`, where the test subject classes are
  ordinary entries ([`arxiv-lib/lib/arXiv/Config/SubjectClasses.pm:385-399`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Config/SubjectClasses.pm#L385-L399)). That
...
* **Listing** comes from `%IN_GROUP_NOT_DEFUNCT`, which deletes `test` **by name**
  ...
  ([`arxiv-lib/lib/arXiv/Config/Archives.pm:346-352`](https://github.com/arXiv/arxiv-lib/tree/develop/lib/arXiv/Config/Archives.pm#L346-L352)). Callers that want it add it
...
**Fix:** `is_submittable_category` in [`submit_ce/domain/event/validators.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/domain/event/validators.py) accepts
...
- [`submit_ce/sword/replace.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/sword/replace.py) — the identifier ladder, paper ownership, and the
...
`[`arxiv-httpd/cgi-bin/sword_license.pl`](https://github.com/arXiv/arxiv-httpd/tree/develop/cgi-bin/sword_license.pl)`. 13 new tests; suite now **1178 passed**.

- [`submit_ce/ui/controllers/sword_license.py`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/controllers/sword_license.py)
- [`submit_ce/ui/templates/submit/sword_license.html`](https://github.com/arXiv/submit-ce/tree/develop/submit_ce/ui/templates/submit/sword_license.html)
...
- [`cicd/cloudbuild-sword-dev-arxiv.yaml`](https://github.com/arXiv/submit-ce/tree/develop/cicd/cloudbuild-sword-dev-arxiv.yaml) — builds the same Dockerfile and deploys
